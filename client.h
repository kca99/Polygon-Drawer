...
private:
    ...
    void drawTriangleBresVersion2( int x0,  int y0,  int x1,  int y1, int x2, int y2, unsigned int r0, unsigned int g0, unsigned int b0,unsigned int r1, unsigned int g1, unsigned int b1,unsigned int r2, unsigned int g2, unsigned int b2);
    ...
    void draw_lineBres(int x1, int y1, int x2, int y2, unsigned int ri, unsigned int gi, unsigned int bi,unsigned int rf, unsigned int gf, unsigned int bf); 
